...
public class SdaMaSetsubishosai extends SdaMaSetsubishosaiKey implements Serializable {
    private String sdaSetsubishosainm;
    ...
    public String getSdaSetsubishosainm() {
        return sdaSetsubishosainm;
    }

    public void setSdaSetsubishosainm(String sdaSetsubishosainm) {
        this.sdaSetsubishosainm = sdaSetsubishosainm == null ? null : sdaSetsubishosainm.trim();
    }
